  ...
  return (
    <section className="flex min-h-[calc(100vh-4rem)] items-center justify-center py-10">
      <div className="w-full max-w-[420px]">
        ...
        <div className="mt-10 rounded-2xl border border-slate-200/80 bg-white px-8 py-10 shadow-[0_12px_40px_-20px_rgb(15_23_42/0.18)] sm:px-10">
  ...
  return (
    <div className="flex items-center justify-center">
      ...
      >
        ...
        <span className="text-lg font-bold tracking-tight text-slate-900">SEOTracker</span>
      </Link>
    </div>
  );
}
